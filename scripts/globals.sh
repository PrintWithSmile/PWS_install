...
function set_globals() {
  ...
  KLIPPER_REPO="https://github.com/PrintWithSmile/klipper.git"

  #================= MOONRAKER ==================#
  MOONRAKER_ENV="${HOME}/moonraker-env"
  MOONRAKER_DIR="${HOME}/moonraker"
  MOONRAKER_REPO="https://github.com/PrintWithSmile/moonraker.git"
  ...
  CROWSNEST_REPO="https://github.com/PrintWithSmile/crowsnest.git"
